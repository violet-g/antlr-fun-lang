...
public interface FunVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitFalseg(FunParser.FalsegContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitTrueg(FunParser.TruegContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitNumg(FunParser.NumgContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitRangeg(FunParser.RangegContext ctx);
}